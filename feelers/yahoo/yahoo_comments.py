	...
	for uuid in comments:
		...
		if "list" in article_comments_data:
			for comment_json in article_comments_data['list']:
				...
				comment_for_upload['article_headline'] = comments[uuid]['article_headline']
				comment_for_upload['article_url'] = comments[uuid]['article_url']
				comment_for_upload['comment_text'] = comment_json['content']
				...
				comment_for_upload['created_on'] = comment_json['createTime']
